...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Line.PolygonSkip = 1
        Line.Rotate = 0F
        Line.RoundedEdges = CustomizableEdges34
        ...
        Guna2TextBox2.FillColor = Color.FromArgb(CByte(34), CByte(37), CByte(46))
        ...
        Guna2TextBox2.Size = New Size(200, 23)
        ...
        Guna2TextBox6.FillColor = Color.FromArgb(CByte(34), CByte(37), CByte(46))
