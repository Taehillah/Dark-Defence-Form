...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Line.PolygonSkip = 1
        Line.Rotate = 0F
        Line.RoundedEdges = CustomizableEdges13
        ...
        ' ComboBox2
        ' 
        ComboBox2.BackColor = Color.FromArgb(CByte(34), CByte(37), CByte(46))
        ComboBox2.FormattingEnabled = True
        ComboBox2.Location = New Point(121, 210)
